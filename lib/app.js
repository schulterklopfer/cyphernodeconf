  ...
  async setupConfigArchive() {
    ...
    if( !fs.existsSync(this.destinationPath('config.7z')) ) {
      ...
      try {
        ...
        this.config.deserialize(this.configurationPassword);
      } catch( err ) {
    ...
    if( versionOverride ) {
      delete this.config.data.gatekeeper_version;
      delete this.config.data.proxy_version;
      delete this.config.data.proxycron_version;
      delete this.config.data.pycoin_version;
      delete this.config.data.otsclient_version;
      delete this.config.data.bitcoin_version;
      delete this.config.data.lightning_version;
      delete this.config.data.sparkwallet_version;
      delete this.config.data.grafana_version;
    }
